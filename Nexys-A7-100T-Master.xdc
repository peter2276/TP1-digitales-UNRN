...
#set_property CLOCK_DDICATED_ROUTE FALSE [get_nets RST_IBUF];
...
set_property -dict { PACKAGE_PIN T13   IOSTANDARD LVCMOS33 } [get_ports { RST }]; #IO_L23P_T3_A03_D19_14 Sch=sw[11]
#set_property -dict { PACKAGE_PIN H6    IOSTANDARD LVCMOS33 } [get_ports { SWITCH[3] }]; #IO_L24P_T3_35 Sch=sw[12]
#set_property -dict { PACKAGE_PIN U12   IOSTANDARD LVCMOS33 } [get_ports { SWITCH[2] }]; #IO_L20P_T3_A08_D24_14 Sch=sw[13]
...
##Buttons
#set_property -dict { PACKAGE_PIN N17   IOSTANDARD LVCMOS33 } [get_ports { RST }]; #IO_L9P_T1_DQS_14 Sch=btnc  #cambiamos de pin por error de implementacion
